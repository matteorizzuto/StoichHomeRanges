...
hareData75 <- merge(hareDemClean, hares.HR75, by = "CollarFrequency") %>% 
...
acruCNtab75 <- gt(acruCNaicRsq.75) %>% fmt_number(columns = 3:9, decimals = 3) %>% tab_header("Model Selection for Red maple C:N - 75% kUD") %>% cols_label(Modnames ="Models formula", K = "K", AICc = "AICc", Delta_AICc = html("&Delta;AICc"), ModelLik ="Model Likelihood", AICcWt = "AICc Weight", LL ="Log-Lik", Cum.Wt = "Cumulative Weight", Rsq = html("R<sup>2</sup>"))

gtsave(acruCNtab75, "../Results/ACRU_CN_75modseltab.tex")
...
# Generate publication quality AIC table
vaanCNtab75 <- gt(vaanCNaicRsq.75) %>% fmt_number(columns = 3:9, decimals = 3) %>% tab_header("Model Selection for Lowbush blueberry C:N - 75% kUD") %>% cols_label(Modnames ="Models formula", K = "K", AICc = "AICc", Delta_AICc = html("&Delta;AICc"), ModelLik ="Model Likelihood", AICcWt = "AICc Weight", LL ="Log-Lik", Cum.Wt = "Cumulative Weight", Rsq = html("R<sup>2</sup>")) 

gtsave(vaanCNtab75, "../Results/VAAN_CN_75modseltab.tex")
...
# Generate publication quality AIC table
acruNPtab75 <- gt(acruNPaicRsq.75) %>% fmt_number(columns = 3:9, decimals = 3) %>% tab_header("Model Selection for Red maple N:P - 75% kUD") %>% cols_label(Modnames ="Models formula", K = "K", AICc = "AICc", Delta_AICc = html("&Delta;AICc"), ModelLik ="Model Likelihood", AICcWt = "AICc Weight", LL ="Log-Lik", Cum.Wt = "Cumulative Weight", Rsq = html("R<sup>2</sup>")) 

gtsave(acruNPtab75, "../Results/ACRU_NP_75modseltab.tex")
...
vaanNPtab75 <- gt(vaanNPaicRsq.75) %>% fmt_number(columns = 3:9, decimals = 3) %>% tab_header("Model Selection for Lowbush blueberry N:P - 75% kUD") %>% cols_label(Modnames ="Models formula", K = "K", AICc = "AICc", Delta_AICc = html("&Delta;AICc"), ModelLik ="Model Likelihood", AICcWt = "AICc Weight", LL ="Log-Lik", Cum.Wt = "Cumulative Weight", Rsq = html("R<sup>2</sup>"))

gtsave(vaanNPtab75, "../Results/VAAN_NP_75modseltab.tex")
...
vaanCPtab75 <- gt(vaanCPaicRsq.75) %>% fmt_number(columns = 3:9, decimals = 3) %>% tab_header("Model Selection for Lowbush blueberry C:P - 75% kUD") %>% cols_label(Modnames ="Models formula", K = "K", AICc = "AICc", Delta_AICc = html("&Delta;AICc"), ModelLik ="Model Likelihood", AICcWt = "AICc Weight", LL ="Log-Lik", Cum.Wt = "Cumulative Weight", Rsq = html("R<sup>2</sup>"))

gtsave(vaanCPtab75, "../Results/VAAN_CP_75modseltab.tex")
...
top.mods.75[[6]] <- vaanNPaicRsq.75[2,]

# Blueberry C:P ratio top models
top.mods.75[[7]] <- vaanCPaicRsq.75[1,]
top.mods.75[[8]] <- vaanCPaicRsq.75[5,]

# Red maple N:P ratio top models
top.mods.75[[9]] <- acruNPaicRsq.75[1,]
top.mods.75[[10]] <- acruNPaicRsq.75[2,]

# Red maple C:N ratio top models
top.mods.75[[11]] <- acruCNaicRsq.75[1,]
top.mods.75[[12]] <- acruCNaicRsq.75[3,]

SumTab75 <- top.mods.75 %>% bind_rows() %>% 
  ...
  tab_row_group(., group = "Red maple C:N top models", rows = c(11,12)) %>% 
...
gtsave(SumTab75, filename = "../Results/ModSel75kUD_SummaryTable.tex")
...
Lowbush blueberry C:P ratio       Body Weight, CV
Red maple N:P ratio               None
Red maple C:N ratio               Body Weight