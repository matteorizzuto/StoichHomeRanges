...
forest_reproj <- st_transform(forest_gdb, CRS("+init=epsg:32622"))

forest_clip <- st_crop(forest_reproj, e)
```
...
```{r overlap-A1425-fig, echo=TRUE, tidy=TRUE}
...
```{r overlap-A1698-fig, echo=TRUE, tidy=TRUE}
# extract the UD contours at 50%, 75%, and 90% isopleths
...
```{r overlap-A3719-fig, echo=TRUE, tidy=TRUE}
# extract the UD contours at 50%, 75%, and 90% isopleths
...
# visualzie the array of results
A3769_olap
...
```{r overlap-A3769-fig, echo=TRUE, tidy=TRUE}
# extract the UD contours at 50%, 75%, and 90% isopleths
...
```{r olap-table, tidy=TRUE, results='hide'}
