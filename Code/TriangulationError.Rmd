...
> **Note**: This step can be *quite* time consuming and computationally 
intensive. On a machine with a Quad-Core Intel Core i7 2.5 GHz with 16 Gb RAM, 
it took about **XXX hours**. Please, allocate as much or more time to complete 
...
```{r error-atm-fit, echo=TRUE, tidy=TRUE}
...
```{r error-atm-fits-save, echo=TRUE, tidy=TRUE, message=FALSE, results="hide"}
