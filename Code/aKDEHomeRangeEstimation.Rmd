...
Now let's load the file we just saved the keep going. 
...
And again let's load the file we just saved, to continue with our analyses.
...
```{r ud-export, echo=TRUE, tidy=TRUE}
# export 95% kernels 
