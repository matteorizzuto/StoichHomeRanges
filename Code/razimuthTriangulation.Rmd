...
bl_grid_points <- st_transform(bl_grid_pts, 4326)
...
```{r atm-prep-and-vis-1, echo=TRUE,tidy=TRUE, message=FALSE}
...
```{r atm-fits-save, eval=FALSE, tidy=TRUE, message=FALSE, results="hide"}
